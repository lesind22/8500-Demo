...
> I had to create a new data frame called locations that only show the city and state variables from the gay guides dataset. I had to pass or pipe the variables to the other side of the argument. 
